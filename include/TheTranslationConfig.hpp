...
#define CONVEYOR_SIMULATED_DELAY_UPDATES -1  //< Simulated amount of updates for the motor to start or stop
#define CONVEYOR_DESIRED_STATUS_PIN -1       //< Leave it as -1 to disable the pin
#define CONVEYOR_CURRENT_STATUS_PIN -1       //< Leave it as -1 to disable the pin
...
#define SORTER_DIRECTION_LEFT_PIN -1    //< Leave it as -1 to disable the pin
#define SORTER_DIRECTION_MIDDLE_PIN -1  //< Leave it as -1 to disable the pin
#define SORTER_DIRECTION_RIGHT_PIN -1   //< Leave it as -1 to disable the pin
